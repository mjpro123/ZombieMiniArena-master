...
function findCraftIdFromItem(E) {
    E = E.toUpperCase();
    return exports.CRAFTS[E]
}
exports.findCraftIdFromItem = findCraftIdFromItem;

function findCraftByItemId(E) {
    let O = null;
    for (const R of serverconfig_json_1.default.items)
        if (ItemIds_1.ItemIds[R.name.toUpperCase()] === E) {
            O = R.name.toUpperCase();
            break
        } return exports.CRAFTS[O]
}
