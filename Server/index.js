...
const devconfig_json_1 = __importDefault(
  require("./staticSettings/devconfig.json")
);
...
class WebServer {
  ...
  listen(port) {
    this.server.listen(port, () =>
      Logger_1.Loggers.app.info(
        `Running http on basehead::{0}`,
        devconfig_json_1.default.http_port
      )
    );
  }
}
